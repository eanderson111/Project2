...
$(document).ready(function() {
  ...
  getExamples().then(function(data) {
    ...
    console.log(Oid + " inside get")
    console.log(data.length)
    //var name = data[Oid].first_name + " " + data[Oid].last_name
    //console.log(name)

    $("div#name h2").html(data[Oid].first_name + " " + data[Oid].last_name)
    $("div#address h3").html(data[Oid].address)
    $("div#state h3").html(data[Oid].city + ", " + data[Oid].state )
    $("div#email h3").html(data[Oid].email)
    street = (data[Oid].address + ", " + data[Oid].city + ", " + data[Oid].state )
    console.log(street)
    makeMap(street)
  });
...
function onSuccess(result) {
  ...
  */
  ...
  //removed the list of items under the map
